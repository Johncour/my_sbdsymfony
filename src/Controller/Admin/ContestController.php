...
use App\Entity\Contest, App\Entity\Game;
...
class ContestController extends AbstractController
{
    ...
    #[Route('/newpart/{title}', name: 'app_admin_contest_newpart', methods: ['GET', 'POST'])]
    public function newpart(Request $request, EntityManagerInterface $em, Game $jeu): Response
    {
        // dd($title);
        $contest = new Contest();
        $contest->setGame($jeu);
        $editform = $this->createForm(ContestType::class, $contest);
        $editform->handleRequest($request);
        $editform->remove('winner');
